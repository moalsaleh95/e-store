...
const Header = () => {
  return (
    <header className="container relative flex justify-content-between header mx-auto">
      ...
      <div className="flex" >
        <Link to='/' className='header-item flex justify-content-around px-16 relative'>
          WOMEN
        </Link>

        <Link to='/' className='header-item flex justify-content-around px-16 relative active'>
          MEN
        </Link>
