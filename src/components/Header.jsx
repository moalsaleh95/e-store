        ...
        <div>
          <div className="flex cursor-pointer">
            <div className="dollar-vector" onClick={() => handleClickCurrency()}>
              ...
              <Currency isopen={isopenCart} ref={currencyRef} />
            </div>

            <span className="relative cursor-pointer" onClick={() => handleClickMiniCart()}>
              ...
              <MiniCart isopen={isopenCurrency} ref={cartRef} />
            </span>
          </div>
        </div>
